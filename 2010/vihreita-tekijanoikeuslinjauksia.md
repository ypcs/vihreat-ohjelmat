...
3. Tekijän oikeus kieltää johdannaiset teokset eli uusien teosten tekemisen olemassa olevan teoksen pohjalta, kuitenkin olennaisesti uutta luoden (remix, käännös, cover-versio, näytelmän sovittaminen): suojaajan kesto esimerkiksi teoksen ensijulkaisu + määriteltävä lisäaika. Suoja-aikana teoksen käytöstä on mahdollista sopia tekijän kanssa.
